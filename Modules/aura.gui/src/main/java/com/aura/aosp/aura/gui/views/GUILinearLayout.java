...
import com.aura.aosp.aura.gui.skills.GUICanDip;
import com.aura.aosp.aura.gui.skills.GUICanFocus;
import com.aura.aosp.aura.gui.skills.GUICanToast;
import com.aura.aosp.aura.gui.skills.GUICanFocusDelegate;
import com.aura.aosp.aura.gui.skills.GUICanRestoreBackground;
import com.aura.aosp.aura.gui.skills.GUICanRestoreBackgroundDelegate;
import com.aura.aosp.aura.gui.skills.GUICanRoundedCorners;
import com.aura.aosp.aura.gui.skills.GUICanRoundedCornersDelegate;
        ...
        GUICanRestoreBackground
{
    ...
    public void setMarginLeftDip(int margin)
    {
        ...
        ((MarginLayoutParams) getLayoutParams()).leftMargin = Simple.dipToPx(margin);
    }
    ...
    public void setMarginTopDip(int margin)
    {
        ...
        ((MarginLayoutParams) getLayoutParams()).topMargin = Simple.dipToPx(margin);
    }

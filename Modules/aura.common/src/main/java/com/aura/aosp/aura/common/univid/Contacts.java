...
public class Contacts
{
    ...
    private static List<Identity> createContacts()
    {
        ...
        contacts.add(createContact("carolyn",   "Carolyn Ma",       "DE","aqAdnGjEQ1K8teoP0RFL0w==", "B8g5XbyZT1alRKYIWLXkkw=="));
        contacts.add(createContact("dezi",      "Dennis Zierahn",   "DE","KutRTwvxSt6sA8nDoqVrOg==", "tB13AgMRRJeEQiAJkuSjZQ=="));
        contacts.add(createContact("diana",     "Diana Benedikt",   "DE","BeFrH3xeSyuiLiZwyB20Kw==", "ME4r3IxSQq681SgnskwHZg=="));
        contacts.add(createContact("laurie",    "Laurie Schrey",    "DE","78cV5W8dQ8eb4Ff0YwUQwg==", "pg8QyFc3T5ePKjGq3cgPrw=="));
        ...
        contacts.add(createContact("nili",      "Nilüfer Isbeceren","DE","BOumgmUGSbeXPap8i0DnRA==", "bVbKMFz3SeegdflOOL7WtA=="));
        contacts.add(createContact("nixie",     "Nixie Melendres",  "DE","UHDM9wBjRjq5znp8TqZ9og==", "hhVACpLGTrWBzahOE2S2Xw=="));
        contacts.add(createContact("ola",       "Ola Hirszler",     "DE","r8R5Zo2WToiwVAlkcUTksw==", "HJ7mGKDxTkONeg0LawuuXQ=="));
        contacts.add(createContact("patrick",   "Patrick Zierahn",  "DE","UNYkTd3KS1maAHEMEvtnwQ==", "jE7VdkVTTZueaWPt9U7Q8Q=="));
        contacts.add(createContact("viet",      "Tran The Viet",    "DE","dzrzoVaNSi6bmBbO7F6FDg==", "FWnsn0HRTEu1EEoZjXJaiQ=="));
